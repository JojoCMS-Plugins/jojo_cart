...
{/if}
            <a class="cart-remove" title="remove this item" href="cart/remove/{$i.id}/" rel="nofollow">x</a>
        </td>
...
{if $usediscount}
    <div id="cart-discountcode">
      ...
      <input type="text" size="10" name="discountCode" id="discountCode" value="{$discount.code}" />
