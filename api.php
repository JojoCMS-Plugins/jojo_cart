...
Jojo::registerURI("cart/[action:empty]",                                                        'jojo_plugin_Jojo_cart_update');  // "cart/empty/"
...
$_options[] = array(
    ...
    'category'    => 'Cart',
    'label'       => 'Gift Option',
    'description' => 'If enabled, offers the customer a checkbox which they can tick to mark an item as a gift.',
    'type'        => 'radio',
    'default'     => 'no',
    'options'     => 'yes,no',
    'plugin'      => 'jojo_cart'
...
$_options[] = array(
    'id'          => 'cart_free_gift_message',
    'category'    => 'Cart',
    'label'       => 'Gift Message Option',
    'description' => 'If enabled, offers the customer a field to add a personal message to the gift.',
    'type'        => 'radio',
    'default'     => 'no',
    'options'     => 'yes,no',
    'plugin'      => 'jojo_cart'
